...
Bem-vindo ao projeto **Expenses**! Este é meu aplicativo de despesas pessoais, onde o usuário consegue registrar o quanto gastou e em que dia, além de visualizar um gráfico de como estão seus gastos. O aplicativo armazena as informações de despesas para facilitar o controle financeiro.

## Descrição

O objetivo deste projeto é ajudar os usuários a gerenciar suas finanças pessoais de forma eficiente. A aplicação permite que os usuários adicionem suas despesas diárias e visualizem um gráfico que mostra o padrão de gastos, facilitando o controle e planejamento financeiro.
